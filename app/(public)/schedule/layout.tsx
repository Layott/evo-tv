...
/**
 * Metadata for /schedule, which is a client component and so cannot carry its own.
 *
...
export const metadata = pageMetadata({
  title: "Schedule",
  description: "What is on EVO TV today and for the next fortnight. Every show, every airing, in your own timezone.",
  path: "/schedule",
});
