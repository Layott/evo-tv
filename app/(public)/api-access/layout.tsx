...
/**
 * Metadata for /api-access, which is a client component and so cannot carry its own.
 *
...
export const metadata = pageMetadata({
  title: "Developer API",
  description: "Programmatic access to EVO TV schedules, streams and events for members on a Pro plan.",
  path: "/api-access",
});
