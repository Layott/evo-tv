...
/**
 * Metadata for /events, which is a client component and so cannot carry its own.
 *
...
export const metadata = pageMetadata({
  ...
  description: "Tournaments and competitions EVO TV covers, with fixtures, results and prize pools.",
  path: "/events",
});
