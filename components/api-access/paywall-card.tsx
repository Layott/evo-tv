...
export function ApiPaywallCard() {
  return (
    <div className="rounded-2xl border border-amber-500/40 bg-gradient-to-br from-amber-500/10 via-neutral-950 to-amber-500/10 p-8 text-center">
      <div className="mx-auto mb-4 flex size-12 items-center justify-center rounded-full bg-amber-500/20 text-amber-300">
        <Lock className="size-5" />
      </div>
      <h2 className="text-xl font-bold text-neutral-50">API access is a Premium feature</h2>
