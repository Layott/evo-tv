...
export function LiteModeBanner() {
  ...
  return (
    <div
      role="status"
      className="sticky top-0 z-50 w-full border-b border-neutral-800 bg-neutral-900/95 backdrop-blur"
    >
      <div className="mx-auto flex max-w-7xl items-center gap-3 px-4 py-1.5 text-xs">
        ...
        <Link
          ...
          className="hidden text-neutral-300 underline-offset-2 hover:text-neutral-100 hover:underline sm:inline"
        >
          Change
        </Link>
        <button
          ...
          className="rounded-md px-2 py-0.5 text-neutral-400 hover:bg-neutral-800 hover:text-neutral-100"
        >
          Turn off
        </button>
        <button
