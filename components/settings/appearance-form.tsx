        ...
        {OPTIONS.map((o) => {
          ...
          return (
            <Label
              key={o.v}
              htmlFor={`theme-${o.v}`}
              className="flex cursor-pointer items-center gap-3 rounded-xl border border-border bg-card/40 p-4 transition hover:has-[:checked]:has-[:checked]:bg-sky-500/25"
            >
